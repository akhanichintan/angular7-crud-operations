...
var routes = [
    ...
    { path: 'user', component: _users_list_users_list_component__WEBPACK_IMPORTED_MODULE_3__["UsersListComponent"] },
    { path: 'add', component: _create_user_create_user_component__WEBPACK_IMPORTED_MODULE_4__["CreateUserComponent"] },
];
...
module.exports = "<div style=\"padding: 20px;\">\n  <h1 style=\"color: blue\">{{title}}</h1>\n  <h3>{{description}}</h3>\n  <nav>\n    <a routerLink=\"user\" class=\"btn btn-primary active\" role=\"button\" routerLinkActive=\"active\">Users</a>\n    &nbsp;&nbsp;\n    <a routerLink=\"add\" class=\"btn btn-primary active\" role=\"button\" routerLinkActive=\"active\">Add</a>\n  </nav>\n  <router-outlet></router-outlet>\n</div>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(_http) {
        ...
        this.APP_URL = 'http://localhost:8081/user-mgmt';
    }
    // Method to fetch all users through REST service.
    AppComponent.prototype.getAllUsers = function () {
        var _this = this;
        this._http.get(this.APP_URL + '/getUsers').subscribe(function (data) {
            _this.userList = data;
        }, function (error) {
...
var UserDetailsComponent = /** @class */ (function () {
    function UserDetailsComponent(userService, listComponent) {
        this.userService = userService;
    ...
    UserDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _users_list_users_list_component__WEBPACK_IMPORTED_MODULE_4__["UsersListComponent"]])
...
var UserService = /** @class */ (function () {
    function UserService(http) {
        this.http = http;
        this.baseUrl = 'http://localhost:8081/user-mgmt';
    }
...
module.exports = "<h1>Users</h1>\n \n<div *ngFor=\"let user of users | async\" style=\"width: 300px;\">\n  <user-details [user]='user'></user-details>\n</div>\n"
...
var UsersListComponent = /** @class */ (function () {
    ...
    UsersListComponent.prototype.reloadData = function () {
...
module.exports = __webpack_require__(/*! D:\Technologies\Angular\angular-crud-operations\src\main.ts */"./src/main.ts");
